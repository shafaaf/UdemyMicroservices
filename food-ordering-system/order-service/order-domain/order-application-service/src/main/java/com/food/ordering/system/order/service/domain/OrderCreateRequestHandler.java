...
public class OrderCreateRequestHandler {
    ...
    public OrderCreateRequestHandler(OrderDomainService orderDomainService, OrderRepository orderRepository, CustomerRepository customerRepository, RestaurantRepository restaurantRepository, OrderDataMapper orderDataMapper) {
    ...
    private Restaurant checkRestaurant(CreateOrderRequest createOrderRequest) {
        ...
        if (optionalRestaurant.isEmpty()) {
            ...
            throw new OrderDomainException("Could not find restaurant with restaurant id: {}" + createOrderRequest.getRestaurantId());
        }
